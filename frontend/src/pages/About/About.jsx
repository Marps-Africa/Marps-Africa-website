          ...
          {[
            {
              ...
              description:
                "Take advantage of the various online services that can be available to you on the go.",
            },
            {
              icon: <FaCloud className="text-white text-2xl" />,
              title: "Cloud Services",
              description:
                "We have partnered with Amazon to bring you the best cloud-based quality services.",
            },
            {
              icon: <FaShieldAlt className="text-white text-2xl" />,
              title: "IT Security",
              description:
                "We offer design and build services for you from initial sketches to the final construction.",
            },
            {
              icon: <FaCode className="text-white text-2xl" />,
              title: "Software Solutions",
              description:
                "We are a dynamic niche I.T. company that has been helping visionary financial institutions with security support.",
            },
            {
      ...
      <div className="bg-gray-100 py-10 md:py-16 px-4 md:px-10 lg:px-20 flex flex-col lg:flex-row gap-10">
        <div className="lg:w-1/2">
          ...
          <p className="text-xs md:text-sm lg:text-base text-gray-600 leading-relaxed mb-4">
            Interactive communication enhances the building and improving of
            Customer Service by also involving, recognizing and linking all
            business processes—including databases, employees, and client
            communication—into one corporate information system which enables
            better servicing of clients with minimal human involvement.
          </p>
          <p className="text-xs md:text-sm lg:text-base text-gray-600 leading-relaxed mb-4">
            We know our clients' brands inside and out. This assures them that
            they are in safe, objective hands.
          </p>
          ...
          <div className="flex flex-col gap-4 mt-4">
            {[
              {
                icon: (
                  <FaBuilding className="text-2xl md:text-3xl lg:text-4xl mr-3" />
                ),
                text: "Banks",
              },
              {
                icon: (
                  <FaDollarSign className="text-2xl md:text-3xl lg:text-4xl mr-3" />
                ),
                text: "SACCOs",
              },
              {
                icon: (
                  <FaHandHoldingUsd className="text-2xl md:text-3xl lg:text-4xl mr-3" />
                ),
                text: "Finance firms",
              },
            ].map((item, index) => (
              ...
              <div key={index} className="flex flex-col mb-6">
                ...
                <div className="relative pt-1">
                  ...
                  <div className="relative flex items-center w-full bg-gray-400 h-2 rounded">
                    <div
                      className="absolute top-0 left-0 h-2 bg-primary-100   rounded"
