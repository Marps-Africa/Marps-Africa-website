...
const ConsultingProcess = () => {
  return (
    <section className="mx-2 pb-8">
      <div className="md:w-[80vw] mx-auto flex flex-col lg:flex-row justify-between items-start p-10 shadow-lg  bg-white rounded-lg">
        {/* Left Section - Main Content */}
        <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
          <h3 className="text-xl text-primary-100 font-semibold mb-2">
            Consultation
          </h3>
          ...
          <ul className="mt-8 space-y-3 text-lg">
            <li className="flex items-center">
              <span className="text-primary-100 text-xl mr-2">✔</span>
        ...
        <div className="w-full lg:w-1/2 relative">
          ...
          <div className="flex items-start mb-10 pl-12">
            <div className="w-8 h-8 flex items-center justify-center bg-blue-100 text-primary-100 rounded-full text-lg font-bold">
              01
            </div>
