          ...
          >
            ...
            <div className="flex justify-end">
              <Link
                ...
                className="self-start mt-2 bg-primary-100 text-white h-10 w-10 text-center rounded-full shadow transition duration-300 flex items-center justify-center"
      ...
      <div className="w-full md:w-[90vw] lg:w-[80vw]  mx-auto py-8 px-2 md:px-0">
        ...
        <div className="mt-6 flex flex-wrap justify-between gap-4 bg-white p-2 rounded-md shadow-md">
          {tabs.map((tab) => (
            <button
              key={tab}
              className={`px-4 py-3 rounded-md font-semibold text-sm transition duration-300 ${
                selectedTab === tab
                  ? "bg-black text-white "
                  : "bg-gray-200 md:bg-white hover:bg-gray-300"
              }`}
