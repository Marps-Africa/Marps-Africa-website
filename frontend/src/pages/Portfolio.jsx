      ...
      >
        {[
          ...
          <a
            key={index}
            href="#"
            className="relative block overflow-hidden rounded-lg border border-gray-300 p-4 sm:p-6 lg:p-8 transition-transform duration-300 hover:scale-105 hover:border-primary-100 hover:border-2 hover:shadow-lg"
          >
            <img
              alt=""
              src={image}
            ...
            <dl className="mt-6 flex gap-4 sm:gap-6">
              <div className="flex flex-col-reverse">
                <a
                  ...
                  className="border-2 border-primary-100 rounded-lg text-primary-100 hover:bg-blue-500 hover:text-white px-4 py-2 transition duration-300 ease-in-out"
                >
                  Explore
                </a>
              </div>
