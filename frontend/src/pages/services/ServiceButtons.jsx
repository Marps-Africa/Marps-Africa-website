  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-20 left-6 z-50 lg:hidden bg-primary-100 text-white p-2 rounded-lg"
      >
        <Menu size={24} />
      </button>
      ...
      <div
        ...
        ${
          sidebarOpen
            ? "top-0 left-0 h-full w-64 translate-x-0"
            : "top-0 left-0 h-full w-64 -translate-x-full"
        }
        lg:translate-x-0 lg:h-auto lg:w-auto
      `}
      >
        <h2 className="flex justify-center text-3xl font-bold text-primary-100 mb-6">
          Our Services
        </h2>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `px-2 hover:bg-gray-300 hover:underline rounded-lg text-gray-700 ${
                isActive ? "bg-primary-100 text-white hover:bg-blue-700" : ""
              }`
            }
          >
